...
current_dir = Path(__file__).resolve().parent  # policy/video2act directory
...
from train.train_video2act import train

from accelerate.logging import get_logger


def parse_args(input_args=None):
    parser = argparse.ArgumentParser(description="Main script for training Video2Act.")
    parser.add_argument(
        "--model_config_path",
        type=str,
    ...
    parser.add_argument(
        ...
        help="Path to the configuration file. Default is `configs/video2act_template.yaml`.",
    )
    parser.add_argument(
        "--deepspeed",
        type=str,
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "   This can be either:\n"
            "   - a string, the *model id* of a pretrained model hosted inside a model repo on huggingface.co, e.g., `a compatible base policy checkpoint`,\n"
            "   - a path to a *directory* containing model weights saved using [`~Video2ActRunner.save_pretrained`] method, e.g., `./my_model_directory/`.\n"
    ...
    parser.add_argument(
        "--use_framepack_features",
        action="store_true",
        default=False,
        help="Whether or not to use FramePack features for training.",
    )
    parser.add_argument(
        "--scale_lr",
        action="store_true",
    ...
    parser.add_argument(
        "--use_realtime_framepack_features",
        action="store_true",
        default=False,
        help="Whether or not to use real-time framepack features for training.",
    )
